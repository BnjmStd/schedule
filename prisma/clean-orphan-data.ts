...
async function main() {
  ...
  console.log(`⚠️  Se encontraron ${orphanSchools.length} escuelas sin usuarios:`);
  ...
  console.log(`✅ Se eliminaron ${deleteResult.count} escuelas y todos sus datos relacionados.`);
